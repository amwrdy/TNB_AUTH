...
namespace TNB_API.DAL.Models
{
    public partial class NewConnection
    {
        public NewConnection()
        {
            ...
            NewConnectionApprovalInformations = new HashSet<NewConnectionApprovalInformation>();
            NewConnectionAttachments = new HashSet<NewConnectionAttachment>();
            NewConnectionCallLogs = new HashSet<NewConnectionCallLog>();
            NewConnectionCancelInformations = new HashSet<NewConnectionCancelInformation>();
            NewConnectionContractors = new HashSet<NewConnectionContractor>();
            NewConnectionReworkInformations = new HashSet<NewConnectionReworkInformation>();
            NewConnectionSubmitSystemMessages = new HashSet<NewConnectionSubmitSystemMessage>();
        }
        ...
        public bool HasCarelineEdit { get; set; }
        ...
        public virtual NewConnectionLandlordTenant NewConnectionLandlordTenant { get; set; }
        public virtual NewConnectionTechnical NewConnectionTechnical { get; set; }
        public virtual ICollection<NewConnectionApplicationStatus> NewConnectionApplicationStatuses { get; set; }
        public virtual ICollection<NewConnectionApprovalInformation> NewConnectionApprovalInformations { get; set; }
        ...
        public virtual ICollection<NewConnectionCancelInformation> NewConnectionCancelInformations { get; set; }
        public virtual ICollection<NewConnectionContractor> NewConnectionContractors { get; set; }
        public virtual ICollection<NewConnectionReworkInformation> NewConnectionReworkInformations { get; set; }
        public virtual ICollection<NewConnectionSubmitSystemMessage> NewConnectionSubmitSystemMessages { get; set; }
    }
}
